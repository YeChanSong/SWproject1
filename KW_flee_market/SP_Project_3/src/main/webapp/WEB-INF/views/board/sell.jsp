	...
	<div class ="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class ="panel-heading">
				판매 게시판
				<button id='regBtn' type="button" onclick="location.href='/board/register_sell'" class="btn btn-xs pull-right">글 작성</button>
			</div><!-- /.pannel-heading -->	
			...
			<c:forEach var="boardVO" items="${list}">
				<tr>
					...
					<td><a href='/board/read_sell?bno=${boardVO.bno}'>${boardVO.title}</a></td>
			...
			<c:if test="${pageMaker.prev}">
				...
				<a href="sell${pageMaker.makeQuery(pageMaker.startPage - 1) }">«</a>
			...
			<c:forEach begin="${pageMaker.startPage }"
				...
				<a href="sell${pageMaker.makeQuery(idx)}">${idx}</a>
			...
			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				...
				<a href="sell${pageMaker.makeQuery(pageMaker.endPage +1) }"> » </a>
