	...
	<div class= "col-lg-12">
		...
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<button id="ListBtn" class="btn btn-default" onclick="location.href='board/purchase'">List</button>
	...
	<!-- /.row -->
		...
		$(document).ready(function(){
			...
			$("#ModiBtn").on("click",function(){
				Formobj.attr("action","/board/modify_purchase");
			...
			$("#DelBtn").on("click",function(){
				Formobj.attr("action","/board/remove_purchase");
				Formobj.submit();
			});
