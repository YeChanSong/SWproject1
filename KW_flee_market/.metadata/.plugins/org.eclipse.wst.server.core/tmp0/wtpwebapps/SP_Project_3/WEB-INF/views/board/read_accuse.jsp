	...
	<div class= "col-lg-12">
		...
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<button id="ListBtn" class="btn btn-default" onclick="location.href='board/accuse'">List</button>
	...
	<!-- /.row -->
		...
		$(document).ready(function(){
			...
			$("#ModiBtn").on("click",function(){
				Formobj.attr("action","/board/modify_accuse");
			...
			$("#DelBtn").on("click",function(){
				Formobj.attr("action","/board/remove_accuse");
				Formobj.submit();
			});
